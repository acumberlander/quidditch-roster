...
// const getAllPlayersFromDb = () => axios.get(`${baseUrl}/players.json`);
  ...
  axios
    ...
    // problem: result is an object and I need it to be an array
      ...
      if (allTeamsObject != null) {
        Object.keys(allTeamsObject).forEach((team) => {
          const newTeam = allTeamsObject[team];
          newTeam.id = team;
  ...
  axios
    ...
    // problem: result is an object and I need it to be an array
      ...
      if (allPositionsObject != null) {
        Object.keys(allPositionsObject).forEach((position) => {
          const newPosition = allPositionsObject[position];
